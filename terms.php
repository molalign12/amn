...
<title>Terms of Service | Amnen Guest House</title>
...
<style>
body { background: #0D0D0D; color: #F5F0E8; font-family: 'DM Sans', sans-serif; margin: 0; overflow-x: hidden; }
...
<main class="content-section">
    ...
    <p>Welcome to Amnen Guest House. By accessing our website and using our reservation system, you agree to comply with and be bound by the following terms and conditions.</p>
    
    <h2>1. Booking & Reservations</h2>
    <p>All reservations are subject to availability. By making a booking, you warrant that you are at least 18 years old and possess the legal authority to enter into a binding agreement.</p>

    <h2>2. Payment & Billing</h2>
    <p>Full payment or a deposit may be required to confirm your reservation. We accept major credit/debit cards and mobile banking through our secure processor. Rates are quoted in ETB and are inclusive of applicable taxes unless stated otherwise.</p>

    <h2>3. Cancellation & Refunds</h2>
    <p>Cancellation policies vary by room type and rate. Standard bookings may be cancelled up to 48 hours before the check-in date for a full refund. Cancellations made within 48 hours may incur a penalty fee equivalent to the first night's stay.</p>

    <h2>4. Guest Responsibility</h2>
    <p>Guests are expected to behave in a respectful manner and comply with hotel house rules. Any damage to property or disturbance to other guests may result in immediate eviction without a refund and additional charges for damages.</p>

    <h2>5. Limitation of Liability</h2>
    <p>Amnen Guest House is not liable for any loss, damage, or injury sustained during your stay, except where required by law. We strongly recommend guests maintain travel insurance.</p>

    <h2>6. Governing Law</h2>
    <p>These terms are governed by and construed in accordance with the laws of Ethiopia. Any disputes will be subject to the exclusive jurisdiction of the courts in Hawassa, Ethiopia.</p>
</main>
